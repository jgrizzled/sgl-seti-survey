"""(ZTF port of the WISE script.) First-cut recurrence analysis over ScreenMatch records (plan §3.4:
...
Usage: uv run python surveys/ztf/scripts/screen_recurrence.py
"""
...
VISIT_GAP_DAYS = 3.0  # ZTF revisit cadence
N_ZBINS = 24
...
def main() -> None:
    ...
    R_TIGHT_ARCSEC = 2.0  # ~1 seeing FWHM
