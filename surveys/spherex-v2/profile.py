...
WISE_FREEZE = REPO / "surveys" / "wise-v2" / "configs" / "v2_0_freeze.json"
...
def endpoints_with_tensors():
    return sorted({p.stem.split("__")[0] for p in (V1_CAL / "tensors").glob("*.npz")})
...
PROFILE = ArchiveProfile(
    name="spherex", survey_dir=REPO / "surveys" / "spherex-v2", run_dir=REPO / "runs" / "spherex-v2", v1_run_dir=V1,
    ...
    extra_params={"psf": "exposure PSF plane (10x oversampled)", "template": "v3 static-sky template subtracted at sampling",
