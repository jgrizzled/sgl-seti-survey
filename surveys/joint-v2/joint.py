...
Usage: uv run python surveys/joint-v2/joint.py --set dev|confirmatory [--force]
"""
...
sys.path.insert(0, str(REPO / "surveys" / "ztf-v2"))
sys.path.insert(0, str(REPO / "surveys" / "panstarrs-v2"))
...
ZTF = _load("ztf_profile", REPO / "surveys" / "ztf-v2" / "profile.py").PROFILE
PS1 = _load("ps1_profile", REPO / "surveys" / "panstarrs-v2" / "profile.py").PROFILE
...
SURVEY_DIR = REPO / "surveys" / "joint-v2"
