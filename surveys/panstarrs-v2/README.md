...
v2 re-analysis of the v1 panstarrs survey under the frozen rule in
...
Stages: `uv run python surveys/panstarrs-v2/run.py {freeze,geometry,build,nulls,inject,completeness,adjudicate,report}`
