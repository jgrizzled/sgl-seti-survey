"""First-cut recurrence analysis over ScreenMatch records (plan §3.4:
...
Usage: uv run python surveys/wise/scripts/screen_recurrence.py
"""
...
SCREEN_DIR = REPO / "runs" / "wise" / "screen_v1"
VISIT_GAP_DAYS = 5.0
N_ZBINS = 24
...
def main() -> None:
    ...
    R_TIGHT_ARCSEC = 3.0
    Z_GRID = np.geomspace(Z_MIN, Z_MAX, 120)
