"""(DECam port of the PS1/ZTF/WISE script.) First-cut recurrence analysis over ScreenMatch records (plan §3.4:
...
Usage: uv run python surveys/decam/scripts/screen_recurrence.py
"""
...
SCREEN_DIR = REPO / "runs" / "decam" / "screen_v1"
VISIT_GAP_DAYS = 3.0  # same-night + adjacent-night PI blocks collapse; revisits are weeks apart
N_ZBINS = 24
...
def main() -> None:
    ...
    R_TIGHT_ARCSEC = 1.2  # ~1 seeing FWHM at CTIO
