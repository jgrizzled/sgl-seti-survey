...
| O14 | **PSP/WISPR 0.1 AU sunward survey** | §5.18 | Third heliospheric substrate, on the cell HI-1 constrained at 12–61 MW: recon first (in-field point-source depth vs r on L2/L2b/L3, header verification of the ram-side field model, cadence/campaign structure, encounter-local baseline design, Mercury/Venus positive control), then the LASCO/HI-1 chain. Public L2 through E27 on the anonymous NRL tree | Ready (recon not started) |
