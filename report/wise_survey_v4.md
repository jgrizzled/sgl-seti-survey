---
title: "WISE/NEOWISE SGL Survey — Report v4 (v2 re-analysis under a frozen decision rule)"
date: 2026-08-22
status: "complete — blind confirmatory run of 61 endpoints / 488 cells: 0 candidates at family-wise α = 0.05; development set 27 endpoints / 216 cells: 0 candidates; 8,448 injection-calibrated constraints with confidence intervals; supersedes wise_survey_v3.md (erratum v3.1)"
---

# WISE/NEOWISE SGL Survey — Report v4

**Pins:** registry v1.5 `sha256:794d9f90…` · hypotheses **v2.1**
(`surveys/wise-v2/hypotheses.md`, freeze
...
`surveys/wise-v2/scripts/report_tables.py` (`surveys/wise-v2/results/report_tables.md`).

## Summary

Report v3 claimed a 90 %-complete exclusion with an "empirical FAR
...
the geometry and provenance claims were metadata. Erratum v3.1
withdrew those claims. This report is the v2 re-analysis of the same
...
0.66). The v1 W4 kernel was also twice too wide in pixels (erratum
v3.1 item 9); v2 reads the pixel scale from the header.
...
`surveys/wise-v2/scripts/run_v2.sh A–I`.
