---
title: "ZTF survey — Report v2 (frozen decision rule, blind confirmatory run)"
date: 2026-08-23
status: "complete — confirmatory 45 endpoints / 228 cells: 0 candidates at family-wise α = 0.05; development 24 / 102: 0 candidates; 5,312 injection-calibrated constraints; supersedes ztf_survey_v1.md (status note 2026-08-22)"
---

# ZTF survey — Report v2

**Pins:** registry v1.5 · hypotheses `surveys/ztf-v2/hypotheses.md` v2.0
...
`surveys/ztf-v2/results/report_tables.md` (ledger-generated).
...
As WISE v2.1 (`surveys/wise-v2/hypotheses.md` §3–§5, §8) with ZTF
