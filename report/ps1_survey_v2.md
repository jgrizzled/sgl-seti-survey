---
title: "Pan-STARRS1 survey — Report v2 (frozen decision rule, blind confirmatory run)"
date: 2026-08-23
status: "complete — confirmatory 45 endpoints / 450 cells: 0 candidates at family-wise α = 0.05; development 24 / 240: 0 candidates; 11,040 injection-calibrated constraints; supersedes ps1_survey_v1.md (status note 2026-08-22)"
---

# Pan-STARRS1 survey — Report v2

**Pins:** registry v1.5 · hypotheses `surveys/panstarrs-v2/hypotheses.md`
v2.0 (freeze `sha256:be6f3a1c…`) · common T0 = 59800 · engine
`sglsurvey/v2/` · AnalysisRuns in `runs/panstarrs-v2/records/` · numbers
from `surveys/panstarrs-v2/results/report_tables.md`.
