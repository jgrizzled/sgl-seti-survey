---
title: "Joint Pan-STARRS1 + ZTF stage (one family-wise rule across archives)"
date: 2026-08-23
status: "complete — confirmatory 45 endpoints / 230 joint cells: 0 candidates at family-wise α = 0.05; development 24 / 102: 0 candidates; 5,280 joint constraints; supersedes the v1 report (removed in the v1 retirement, 2026-08-24; git history)"
---
...
freeze `surveys/joint/configs/v2_freeze.json` `sha256:9bb5791f…` ·
common T0 = 59800, AB zero point 25 · `surveys/joint/joint.py` ·
